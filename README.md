...
- `about_us.html` - FoodBox background and staff
- `services.html` - product table, crop updates, and satisfied users
- `events_news.html` - community events and promotions
- `contact_us.html` - registration form with UK-only delivery wording
- `register.html` - static form submission display page
